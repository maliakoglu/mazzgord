...
const CSP = "default-src 'self'; script-src 'self' 'unsafe-inline' https://a.impactradius-go.com https://cdn1.impact.com https://pagead2.googlesyndication.com https://cdn.jsdelivr.net https://static.iyzipay.com https://www.clarity.ms https://scripts.clarity.ms https://c.clarity.ms https://www.googletagmanager.com https://accounts.google.com https://googleads.g.doubleclick.net https://ep1.adtrafficquality.google https://ep2.adtrafficquality.google https://tpc.googlesyndication.com https://www.google.com https://static.cloudflareinsights.com; style-src 'self' 'unsafe-inline'; font-src 'self'; img-src 'self' data: https:; connect-src 'self' https://a.impactradius-go.com https://cdn1.impact.com https://api.web3forms.com https://api.iyzipay.com https://api.iyzipay.com https://pagead2.googlesyndication.com https://ep1.adtrafficquality.google https://www.google-analytics.com https://analytics.google.com https://www.google.com https://*.clarity.ms https://www.googletagmanager.com https://accounts.google.com https://googleads.g.doubleclick.net https://ep1.adtrafficquality.google https://ep2.adtrafficquality.google https://tpc.googlesyndication.com https://static.cloudflareinsights.com https://www.google.com; frame-src https://a.impactradius-go.com https://cdn1.impact.com https://googleads.g.doubleclick.net https://pagead2.googlesyndication.com https://api.iyzipay.com https://api.iyzipay.com https://*.iyzico.com https://*.iyzipay.com https://www.google.com https://maps.google.com https://accounts.google.com; object-src 'none'; base-uri 'self'";
...
const blogDates = {
  ...
  "/blog/uc-dunya-ceviri": "2026-02-14",
  ...
  "/blog/arac-ruhsati-cevirisi": "2026-08-28",
  "/blog/ingiltere-vize-cevirisi-gercek-vaka": "2026-08-28",
  "/blog/dogalgaz-faturasi-cevirisi": "2026-08-28",
  "/blog/vize-formatlari": "2026-08-28",
};

const blogRelated = {
  "/blog/yeminli-tercume": ["/blog/ceviri-hatalari", "/blog/teknik-ceviri", "/blog/yeminli-tercume-fiyatlari-2026"],
  "/blog/teknik-ceviri": ["/blog/teknik-ceviri-nedir", "/blog/uc-dunya-ceviri", "/blog/ceviri-teknolojileri"],
  ...
  "/blog/hukuki-ceviri": ["/blog/uc-dunya-ceviri", "/blog/ingilizce-sozlesme-cevirisi", "/blog/yeminli-tercume"],
  "/blog/uc-dunya-ceviri": ["/blog/hukuki-ceviri", "/blog/teknik-ceviri", "/blog/yeminli-tercume"],
  "/blog/ceviri-hatalari": ["/blog/ceviri-teknolojileri", "/blog/ceviri-ipuclari", "/blog/cevirmenlik-kariyer-rehberi"],
  "/blog/cevirmenlik-kariyer-rehberi": ["/blog/ceviri-teknolojileri", "/blog/ceviri-hatalari", "/blog/ceviri-sektoru"],
  "/blog/ceviri-teknolojileri": ["/blog/ceviri-hatalari", "/blog/google-translate-vs-profesyonel-ceviri", "/blog/ceviri-sektoru"],
  ...
  "/blog/ingilizce-sozlesme-cevirisi": ["/blog/hukuki-ceviri", "/blog/uc-dunya-ceviri", "/blog/ingilizce-edebi-metin-cevirisi"],
  ...
  "/blog/noter-onayli-ceviri": ["/blog/yeminli-tercume", "/blog/uc-dunya-ceviri", "/blog/hukuki-ceviri"],
  ...
  "/blog/arac-ruhsati-cevirisi": ["/blog/pasaport-tercumesi-nasil-yapilir", "/blog/yeminli-tercume", "/blog/vize-ceviri"],
  "/blog/ingiltere-vize-cevirisi-gercek-vaka": ["/blog/vize-ceviri", "/blog/vize-formatlari", "/blog/yeminli-tercume"],
  "/blog/dogalgaz-faturasi-cevirisi": ["/blog/arac-ruhsati-cevirisi", "/blog/ingiltere-vize-cevirisi-gercek-vaka", "/blog/yeminli-tercume"],
  "/blog/vize-ceviri": ["/blog/uc-dunya-ceviri", "/blog/vize-formatlari", "/blog/pasaport-tercumesi-nasil-yapilir"],
  ...
  "/blog/vize-formatlari": ["/blog/vize-ceviri", "/blog/ingiltere-vize-cevirisi-gercek-vaka", "/blog/yeminli-tercume"],
};
...
const blogTitles = {
  ...
  "/blog/uc-dunya-ceviri": "Teknik, Hukuk ve Vize Çeviri Rehberi",
  ...
  "/blog/arac-ruhsati-cevirisi": "Araç Ruhsatı Çevirisi",
  "/blog/ingiltere-vize-cevirisi-gercek-vaka": "İngiltere Vize Çevirisi",
  "/blog/dogalgaz-faturasi-cevirisi": "Doğalgaz Faturası Çevirisi",
};
...
export async function processResponse(response, path) {
  ...
  const servicePages = {
    ...
    "/noter-onayli-tercume": { name: "Noter Onaylı Tercüme", desc: "Yeminli tercüman tarafından yapılan, noter tasdikli resmi belge çevirisi" },
    "/apostil-tercume": { name: "Apostil Tercüme", desc: "Yurt dışı işlemler için apostil tasdikli yeminli çeviri hizmeti" },
    "/transkript-ceviri": { name: "Transkript Çevirisi", desc: "Transkript çevirisi — yurt dışı eğitim başvuruları için yeminli tercüme" },
    "/adli-sicil-cevirisi": { name: "Adli Sicil Çevirisi", desc: "Adli sicil çevirisi — vize, göçmenlik ve iş başvuruları için yeminli tercüme" },
    "/nufus-kayit-ornegi-cevirisi": { name: "Nüfus Kayıt Örneği Çevirisi", desc: "Nüfus kayıt örneği çevirisi — vize, konsolosluk ve resmi işlemler için yeminli tercüme" },
    "/acil-tercume": { name: "Acil Tercüme", desc: "Acil çeviri — aynı gün teslimat. İngilizce-Türkçe yeminli tercüme" },
    "/denizli-yeminli-tercume": { name: "Denizli Yeminli Tercüme", desc: "Denizli merkezli yeminli tercüman. İngilizce-Türkçe resmi belge çevirisi" },
    "/denizli-noter-onayli-tercume": { name: "Denizli Noter Onaylı Tercüme", desc: "Denizli'de noter onaylı tercüme. Yeminli tercüman tarafından çevrilip noter tasdikli belgeler" },
    "/denizli-pasaport-tercumesi": { name: "Denizli Pasaport Tercümesi", desc: "Denizli'de pasaport çevirisi. Yeminli tercüman tarafından İngilizce veya Türkçe'ye çeviri" },
    "/denizli-diploma-tercumesi": { name: "Denizli Diploma Tercümesi", desc: "Denizli'de diploma ve transkript çevirisi. Yurt dışı eğitim başvuruları için" },
    "/denizli-vize-tercumesi": { name: "Denizli Vize Tercümesi", desc: "Denizli'de vize başvurusu için belge çevirisi. Yeminli tercüman tarafından" },
    "/denizli-apostil-tercume": { name: "Denizli Apostil Tercüme", desc: "Denizli'de apostil tercüme. Yurt dışı işlemler için apostil tasdikli belgeler" },
  };
  ...
  // gtag
  headInjections.push(`<script>window.dataLayer=window.dataLayer||[];function g(){dataLayer.push(arguments)}g('js',new Date());g('config','G-3X2GCEQSDJ',{anonymize_ip:true});var ric=window.requestIdleCallback||function(cb){setTimeout(cb,3000)};ric(function(){var s=document.createElement('script');s.src='https://www.googletagmanager.com/gtag/js?id=G-3X2GCEQSDJ';s.async=true;document.head.appendChild(s)},{timeout:4000})</script>`);


  // Clarity — lazy-load via requestIdleCallback
  headInjections.push(`<script>var ric2=window.requestIdleCallback||function(cb){setTimeout(cb,4000)};ric2(function(){window.clarity=window.clarity||function(){(window.clarity.q=window.clarity.q||[]).push(arguments)};var s=document.createElement('script');s.src='https://www.clarity.ms/tag/xmqtf6l3sq';s.async=true;document.head.appendChild(s)},{timeout:5000})</script>`);
  ...
  if (cssMatch) {
    html = html.replace(cssMatch[0], '<link rel="preload" as="style" href="' + cssMatch[1] + '">' + cssMatch[0]);
  }
