...
export const quoteSchema = z.object({
  ...
  delivery_method: z.enum(["digital", "shipping", "hand_delivery"]).optional().default("digital"),
  ...
  meeting_day: z.string().max(50).nullish().or(z.literal("")),
  meeting_time: z.string().max(50).nullish().or(z.literal("")),
  idempotency_key: z.string().max(100).nullish().or(z.literal("")),
...
export const serviceCreateSchema = z.object({
  sku: z.string().min(1, "SKU zorunlu").max(50, "SKU cok uzun"),
  slug: z.string().min(1, "Slug zorunlu").max(100, "Slug cok uzun"),
  name: z.string().min(1, "Ad zorunlu").max(200, "Ad cok uzun"),
  description: z.string().max(2000).optional().or(z.literal("")),
  category: z.string().min(1, "Kategori zorunlu").max(100),
  source_language: z.string().max(100).optional().or(z.literal("")),
  target_language: z.string().max(100).optional().or(z.literal("")),
  unit: z.string().max(20).optional().or(z.literal("")),
  base_price: z.number().min(0, "Fiyat negatif olamaz").max(100000, "Fiyat cok yuksek"),
  currency: z.string().max(10).optional().or(z.literal("")),
  image: z.string().max(500).optional().or(z.literal("")),
  tax_rate: z.number().min(0, "Vergi negatif olamaz").max(1, "Vergi 0-1 arasi olmali").optional(),
  delivery_type: z.string().max(50).optional().or(z.literal("")),
  sort_order: z.number().int().min(0).max(10000).optional(),
  options: z.array(z.any()).max(50).optional(),
});
...
export const serviceUpdateSchema = z.object({
  ...
  target_language: z.string().max(100).optional().or(z.literal("")),
  unit: z.string().max(20).optional().or(z.literal("")),
  base_price: z.number().min(0, "Fiyat negatif olamaz").max(100000).optional(),
  currency: z.string().max(10).optional().or(z.literal("")),
