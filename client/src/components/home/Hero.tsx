  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background">
      ...
      <div className="container mx-auto px-4 relative z-10 text-center" style={{ maxWidth: '900px' }}>
        <div className="fade-up fade-up-delay-1" style={{ fontFamily: '"JetBrains Mono", monospace', fontSize: '12px', fontWeight: 600, letterSpacing: '3px', marginBottom: '20px', textTransform: 'uppercase', color: 'var(--color-editorial-teal)' }}>
