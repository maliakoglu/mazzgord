...
type IllustrationKey =
  ...
  | "tibbi" | "uc-dunya" | "vize" | "yeminli" | "yerellestirme" | "apostil"
...
const illustrations: Record<IllustrationKey, { gradient: string; svg: ReactNode }> = {
  ...
  apostil: { gradient: "from-amber-50 via-yellow-50 to-emerald-50", svg: (<svg viewBox="0 0 200 120" fill="none" className="w-full h-full"><rect x="55" y="25" width="90" height="70" rx="5" stroke="currentColor" strokeWidth="2.5" /><path d="M70 45h60M70 55h60M70 65h40M70 75h30" stroke="currentColor" strokeWidth="2" strokeLinecap="round" /><circle cx="140" cy="80" r="18" stroke="currentColor" strokeWidth="2.5" /><path d="M132 80h16M140 72v16" stroke="currentColor" strokeWidth="2" strokeLinecap="round" /></svg>) },
}
