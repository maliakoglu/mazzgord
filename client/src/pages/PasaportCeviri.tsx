  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="description" content="Pasaport çevirisi için profesyonel yeminli tercüme hizmeti. İngilizce-Türkçe pasaport tercümesi, vize ve resmi başvurular için hızlı ve güvenilir çeviri. Denizli ve online hizmet." />
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="flex gap-4 p-6 bg-card rounded-xl border border-border"><Shield className="w-8 h-8 text-primary flex-shrink-0" /><div><h3 className="font-bold mb-2">Resmi Geçerlilik</h3><p className="text-muted-foreground text-sm">Yeminli tercüman imzası tüm konsolosluk ve resmi kurumlarda geçerlidir.</p></div></div>
