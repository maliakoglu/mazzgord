  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="description" content="Akademik çeviri hizmeti. Tez, makale, bildiri ve araştırma raporu çevirisi. Bilimsel terminoloji ve akademik üslup. Denizlide profesyonel akademik çeviri." />
        ...
        <meta property="og:url" content="https://mazzgord.com/akademik-ceviri" />
        ...
        <script type="application/ld+json">{`
          {
            ...
            "@type": "Service",
            "serviceType": "Akademik Çeviri Hizmeti",
            "provider": {
              "@type": "Organization",
            ...
            "areaServed": "Denizli, Türkiye",
            "url": "https://mazzgord.com/akademik-ceviri"
          }
        `}</script>
      </Helmet>
