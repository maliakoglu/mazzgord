...
<p>Mazzgord çeviri bürosu olarak geniş yelpazede profesyonel çeviri hizmetleri sunmaktayız. Her bir çeviri kategorisi, alanında uzmanlaşmış tercümanlarımız tarafından yürütülür. Aşağıda detaylı hizmet açıklamalarımızı inceleyebilirsiniz.</p>

<h3 id="yeminli-tercume">Yeminli Tercüme</h3>
<p>Noter onaylı yeminli tercüme hizmetlerimizle resmi dokümanlarınızı hukuki geçerliliğe sahip şekilde çeviriyoruz. Pasaport, diploma, evlilik cüzdanı, mahkeme kararları ve daha fazlası için güvenilir çözüm ortağınızız. Yeminli tercüme işlemlerinizde noter onayı ve apostil hizmetleri de sunuyoruz. <a href="#iletisim">Yeminli tercüme fiyat teklifi almak için iletişime geçin.</a></p>

<h3 id="teknik-ceviri">Teknik Çeviri</h3>
<p>Mühendislik, tıp, IT ve endüstri alanlarında teknik terminoloji bilgisi gerektiren dokümanlarınız için uzman teknik çeviri hizmeti sunuyoruz. Kullanım kılavuzları, ürün spesifikasyonları ve teknik raporlarınızı hedef dile kusursuz şekilde aktarıyoruz. <a href="#ceviri-hizmetlerimiz">Tüm çeviri hizmetlerimizi görüntüleyin.</a></p>

<h3 id="akademik-ceviri">Akademik Çeviri</h3>
<p>Tez, makale, araştırma raporları ve akademik yayınlarınız için alanında uzman akademik çevirmenlerimizle destek veriyoruz. Akademik terminolojiye hakim kadromuzla bildiri ve yayınlarınızı uluslararası standartlara uygun şekilde çeviriyoruz. <a href="#ceviri-hizmetlerimiz">Diğer akademik çeviri çözümlerimiz için tıklayın.</a></p>
...
if old in h:
    ...
    print('✅ İç link yapısı ve anchor menüsü eklendi.')
else:
    print('❌ Eski SEO bloğu bulunamadı. Manuel kontrol gerekebilir.')
